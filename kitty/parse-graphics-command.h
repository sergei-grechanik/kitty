  ...
  while (pos < screen->parser_buf_pos) {
    ...
    case FLAG:
      ...
      case action: {
        ...
        if (g.action != 'd' && g.action != 'f' && g.action != 't' &&
            g.action != 'T' && g.action != 'q' && g.action != 'a' &&
            g.action != 'U' && g.action != 'p') {
      ...
      case delete_action: {
        ...
        if (g.delete_action != 'Z' && g.delete_action != 'C' &&
            g.delete_action != 'F' && g.delete_action != 'c' &&
            g.delete_action != 'p' && g.delete_action != 'n' &&
            g.delete_action != 'x' && g.delete_action != 'a' &&
            g.delete_action != 'Y' && g.delete_action != 'I' &&
            g.delete_action != 'y' && g.delete_action != 'q' &&
            g.delete_action != 'z' && g.delete_action != 'i' &&
            g.delete_action != 'N' && g.delete_action != 'f' &&
      ...
      case transmission_type: {
        ...
        if (g.transmission_type != 'd' && g.transmission_type != 't' &&
            g.transmission_type != 's' && g.transmission_type != 'f') {
          REPORT_ERROR("Malformed GraphicsCommand control block, unknown flag "
